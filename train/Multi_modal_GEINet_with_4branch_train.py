...
from Multi_modal_GEINet_with_4branch import Multi_modal_GEINet



class Multi_modal_Updater(training.StandardUpdater):
    def __init__(self, Mymodel, iterator1, iterator2, iterator3, iterator4, optimizer, converter=convert.concat_examples,
                 device=None,
                 loss_func=None):
    ...
    def update_core(self):
        ...
        in_arrays4 = self.converter(batch4, self.device)
        ...
        if isinstance(in_arrays1, tuple):
            ...
            y = model(in_arrays1[0], in_arrays2[0], in_arrays3[0], in_arrays4[0])
...
def train(mode):
    ...
    updater = Multi_modal_Updater(model, Dt1_train_iter, Dt2_train_iter, Dt3_train_iter, Dt4_train_iter, optimizer, device=0)
    epoch = 6250
