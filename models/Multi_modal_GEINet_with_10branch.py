...
class Multi_modal_GEINet(Chain):
    ...
    def __call__(self, a, b, c, d, e, f, g, h, i, j):
        ...
        root9 = self.GEIBlock(i)
        root10 = self.GEIBlock(j)
        ...
        h6 = F.concat((h6, root8), axis=1)
        h6 = F.concat((h6, root9), axis=1)
        h7 = F.concat((h6, root10), axis=1)
