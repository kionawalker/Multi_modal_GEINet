...
from Multi_modal_GEINet_with_8branch import Multi_modal_GEINet
...
class Multi_modal_Updater(training.StandardUpdater):
    def __init__(self, Mymodel, iterator1, iterator2, iterator3, iterator4, iterator5,
                 iterator6, iterator7, iterator8, optimizer, converter=convert.concat_examples,
                 device=None,
                 loss_func=None):
    ...
    def update_core(self):
        ...
        for i in range(0, len(batch1)):
            ...
            output = model(data1, data2, data3, data4, data5, data6, data7, data8)
...
def train(mode):
    ...
    updater = Multi_modal_Updater(model, Dt1_train_iter, Dt2_train_iter, Dt3_train_iter,
                                  ...
                                  Dt8_train_iter, optimizer, device=0)
    epoch = 6250
